# mirror-normalize-text

Mirror normalization text provider package
...
- `mirror-core>=0.1.0`
- `mirror-normalize>=0.1.0`
- `pydantic>=2.0`

## Entry point

- `text` → `mirror_normalize_text.provider:provider`
...
```bash
pip install mirror-normalize-text
```
