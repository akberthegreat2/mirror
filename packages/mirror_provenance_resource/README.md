# mirror-provenance-resource

Mirror resource capability package
...
- `mirror-core>=0.1.0`
- `pydantic>=2.0`
- `mirror-provenance>=0.1.0`

## Entry point

- `resource` → `mirror_provenance_resource.provider:provider`
...
```bash
pip install mirror-provenance-resource
```
