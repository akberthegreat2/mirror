# mirror-retrieval-memory

Mirror retrieval provider package
...
- `mirror-core>=0.1.0`
- `mirror-retrieval>=0.1.0`
- `mirror-embedding>=0.1.0`
- `mirror-embedding-hash>=0.1.0`
- `mirror-vectorstore>=0.1.0`
- `mirror-vectorstore-memory>=0.1.0`
- `pydantic>=2.0`

## Entry point

- `memory` → `mirror_retrieval_memory.provider:provider`
...
```bash
pip install mirror-retrieval-memory
```
